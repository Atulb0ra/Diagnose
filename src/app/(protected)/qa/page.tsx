...
const QAPage = () => {
  ...
  const [questionInex, setQuestionIndex] = React.useState(0)
  const question = questions?.[questionInex]
            ...
            return <React.Fragment key={question.id}>
              <SheetTrigger onClick = {() => setQuestionIndex(index)}>
                 <div className="flex items-center gap-4 bg-white rounded-lg p-4 shadow border">
                   <img className='rounded-full' height={30} width={30} src={question.user.imgUrl??""} />
      ...
      {question && (
         <SheetContent className='sm:max-w-[75vw]'>
            <SheetHeader>
              ...
              <MDEditor.Markdown source={question.answer}  className='max-h-[45vh] overflow-auto'/>
