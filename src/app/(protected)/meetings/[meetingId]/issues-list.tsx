...
const IssuesList = ({ meetingId }: Props) => {
    ...
    if (isLoading || !meeting) return <div>Loading meeting details...</div>
    return (
        <>
            <div className="p-8">
                <div className="mx-auto flex max-w-2xl items-center  gap-x-8 border-b pb-6 lg:mx-0 lg:max-w-none">
                    <div className="flex items-center gap-x-6">
                        <div className="rounded-full border background-white p-3">
                ...
                <div className="h-4">
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                        {meeting.issues.map(issue => (
                            <div key={issue.id} className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400">
